# ============================================================================
# WLS Regression Test Reference Implementation (R with lm)
# ============================================================================
# This script generates reference values for Weighted Least Squares regression
# using R's lm() function with weights. The test validates that the Rust
# implementation matches R's behavior for coefficient estimates and statistics.
#
# Source: stats::lm (R base) with weights parameter
# Reference: "Applied Linear Statistical Models" (Kutner et al.)
#
# Usage:
#   Rscript test_wls.R [csv_path] [output_dir]
#   Args:
...
cat(sprintf("Running WLS regression test on dataset: %s\n", dataset_name))
...
# Residuals, fitted values, and error metrics
...
# Write output
output_file <- file.path(output_dir, paste0(dataset_name, "_wls.json"))
